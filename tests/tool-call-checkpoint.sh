...
assert_checkpoint() {
	...
	printf '%s' "$output" | jq -e '
		...
		and (.hookSpecificOutput.additionalContext | contains("Once they reset the worker, tell it its next scoped action"))
		...
		and (.hookSpecificOutput.additionalContext | contains("Once they reset Scout, tell it its next scoped action"))
