...
# SKILL.body.md remains the default target, and dist/skills/<name>/SKILL.md is
# regenerated by scripts/build/build-skill-mds.py. A SYNC.md file records
# provenance and upstream SHA so unchanged skills can be skipped.
