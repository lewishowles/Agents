...
# Each skill's SKILL.body.md is overwritten on sync; dist/skills/<name>/SKILL.md
# is regenerated by scripts/build/build-skill-mds.py. A SYNC.md file records provenance and upstream SHA
...
# SKILL.body.md is the local source; the runtime SKILL.md is regenerated under dist/skills/.
#
