...
└── SKILL.md        # Generated by scripts/build/build-skill-mds.py; frontmatter + body combined
```

Run `python3 scripts/build/build-skill-mds.py` after editing `skill.json` or `SKILL.body.md`.
