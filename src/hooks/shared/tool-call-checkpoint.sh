...
readonly TOOL_CALL_CONTEXT='TOOL-CALL CHECKPOINT (20/20): HCOM Scout, Implementer, and Reviewer: send one --intent inform checkpoint only to your direct sender, the peer whose request you are working on (the Orchestrator, or the Reviewer that assigned you). State that you reached a tool-call checkpoint, then hand off: completed work and changed paths; discoveries worth retaining; verification completed or pending; remaining work; and the exact next action. Do not send it to the human or another team member, continue, create a successor, or ask for another packet. Then wait. HCOM Orchestrator receiving that report: it is always a mandatory stop, never a routine progress update, even when the report describes remaining work or names a next action — do not decide the worker should keep going. Assess whether the worker is safe to reset: confirm every discovery is captured in the report text itself (not left only in the worker itself) and list any changed paths. Present the human the completed work, changed paths, discoveries, remaining work, and your safe-to-reset assessment, then ask them to decide whether to reset — do not reset it yourself or resume waiting on your own judgement. Once they reset the worker, tell it its next scoped action. HCOM Orchestrator awaiting a Scout, Implementer, or Reviewer report: keep your exact identity and wait. Do not create a checkpoint, reset yourself, or start a successor. HCOM Orchestrator with no outstanding team-member report: stop expanding this work cycle. Ask the human to reset this Orchestrator, then provide one paste-ready replacement-Orchestrator packet containing the current objective, team status, checkpointed worker and scope, verification, blockers, and next decision. The replacement Orchestrator must inspect team status first, then tell the checkpointed worker its next scoped action. HCOM Reviewer receiving a Scout checkpoint report: it is always a mandatory stop, never a routine progress update, even when the report describes remaining work or names a next action. Assess whether Scout is safe to reset: confirm every discovery is captured in the report text itself and list any changed paths. Present the human the completed work, changed paths, discoveries, remaining work, and your safe-to-reset assessment, then ask them to decide whether to reset — do not reset it yourself or resume waiting on your own judgement. Do not escalate this to the Orchestrator or treat it as your own checkpoint. Once they reset Scout, tell it its next scoped action. HCOM Reviewer awaiting a delegated Scout report: keep your exact identity and wait. Do not create a checkpoint, reset yourself, or start a successor. Outside HCOM, give the user the same compact handoff and wait for a continuation message.'
