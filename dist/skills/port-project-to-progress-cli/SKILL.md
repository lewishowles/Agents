...
name: port-project-to-progress-cli
displayName: Port a project to the progress CLI
description: >
  Use this skill when porting an existing PROGRESS.md and .agent/tasks/*.md onto the progress CLI, including releases, tasks, chunks, notes, context, verification, and safe cleanup.
---
