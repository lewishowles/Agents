...
| `boilersuit` | When using Boilersuit generators for repeatable file generation | `boilersuit`, `generator`, `generators`, `generate files`, `scaffold`, `scaffolding`, `boilerplate`, `repeatable file`, `project inspect`, `generator preview` |
